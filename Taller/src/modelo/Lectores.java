...
public class Lectores {
        ...
        public Lectores() {
                ...
                lectores.get(10).getPrestamoLector().add(new Prestamo(
                                "07/09/2022",
                                "Roberto Perez",
                                LocalDate.of(2022, 9, 11),
                                "Domicilio",
                                Biblioteca.obras().get(0).getEjemplares().get(1),
                                lectores.get(10)));
                Biblioteca.obras().get(0).getEjemplares().get(1)
                                .setPrestamoEjemplar(lectores.get(10).getPrestamoLector().get(0));

                lectores.get(12).getPrestamoLector().add(new Prestamo(
                                "07/10/2022",
                                "Roberto Perez",
                                LocalDate.of(2022, 9, 10),
                                "Domicilio",
                                Biblioteca.obras().get(10).getEjemplares().get(0),
                                lectores.get(12)));
                Biblioteca.obras().get(10).getEjemplares().get(0)
                                .setPrestamoEjemplar(lectores.get(12).getPrestamoLector().get(0));
                ...
                Biblioteca.obras().get(0).getEjemplares().get(2)
                                .setReservaEjemplar(lectores.get(1).getReservaLector().get(0));
                ...
                lectores.get(10).setMulta(new Multa(15, new Devolucion("10/09/2022", "Javier Perez")));
                ...
                lectores.get(4).setMulta(new Multa(15, new Devolucion("03/08/2022", "Javier Perez")));
                ...
                lectores.get(3).setMulta(new Multa(15, new Devolucion("14/05/2022", "Javier Perez")));
                ...
                lectores.get(9).setMulta(new Multa(15, new Devolucion("14/06/2022", "Javier Perez")));
                ...
                lectores.get(5).setMulta(new Multa(15, new Devolucion("14/06/2022", "Javier Perez")));
                ...
                lectores.get(2).setMulta(new Multa(15, new Devolucion("14/06/2022", "Javier Perez")));
                ...
                lectores.get(11).setMulta(new Multa(15, new Devolucion("01/05/2022", "Javier Perez")));
                ...
                lectores.get(8).setMulta(new Multa(15, new Devolucion("10/07/2022", "Javier Perez")));
